...
| Property       | Value |
|---------------|-------|
| Source        | [Roboflow — AECO Construction Safety Dataset](https://roboflow.com) ← *replace with your link* |
| Version       | v3 |
...
### Key Takeaways
1. **`helmet` vs `no_helmet`** confusion is the main error — small head regions at distance are hard to classify.
2. **`machinery`** achieves the highest mAP (0.81) due to distinctive shape and large bounding boxes.
3. **Crowded scenes** (multiple overlapping workers) cause the most false negatives.

Training curves → [`/results/curves/`](./results/curves/)  
Prediction samples → [`/results/evidence/`](./results/evidence/)
...
|----------|--------------|
| Baseline inference | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR_USERNAME/YOUR_REPO/blob/main/notebooks/baseline_inference.ipynb) |
| Training & Evaluation | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR_USERNAME/YOUR_REPO/blob/main/notebooks/training_eval.ipynb) |
...
- [ ] **Ultralytics version:** `ultralytics==8.2.0`  
      Full pip freeze: see [`docs/pip_freeze.txt`](./docs/pip_freeze.txt)
- [ ] **Python version:** 3.10
- [ ] **Training hardware:** Google Colab T4 GPU
- [ ] **Random seed:** `seed=42` (set in training cell)
- [ ] **Weights available:** [GitHub Release v1.0](https://github.com/YOUR_USERNAME/YOUR_REPO/releases/tag/v1.0) → `best.pt`
...
| Document | Link |
|----------|------|
| Mini Report (PDF, 2 pages) | [`docs/mini_report.pdf`](./docs/mini_report.pdf) |
| Presentation Slides (PDF, 6–8 slides) | [`docs/slides.pdf`](./docs/slides.pdf) |
...
**Dataset:** Licensed via Roboflow — see [`docs/governance_checklist.md`](./docs/governance_checklist.md) for details.  
